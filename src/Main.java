...
public class Main {
    public static void main(String[] args) throws Exception {
        ...
        Applicant<String, Double> applicant = new Applicant<>(1, "Wisnu Saputra", "wisnu@gmail.com", "wisnu123",
                "Universitas Indonesia",
                "Fasilkom", 3.90);

        Company<String> company = new Company<>(2, "PT Amartek", "amartek@gmail.com", "amartek123", "Jakarta Selatan",
                "083815499134");
